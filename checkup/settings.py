"""
Django settings for checkup project.
...
SECRET_KEY = 'django-insecure-v!q$yk*=7g*()47@0^b1&l0rjkb*-nznk$9^d*2+b21eeb!_1d'
...
# Specify the HTTP headers that are allowed in cross-origin requests
CORS_ALLOW_HEADERS = [
    'Accept',
    'Accept-Language',
    'Content-Type',
